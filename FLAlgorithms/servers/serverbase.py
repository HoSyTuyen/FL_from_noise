...
class Server:
    def __init__(self, args, model, seed):
        ...
        self.K = args.K
        self.model = copy.deepcopy(model[0]).to(args.device)
    ...
    def select_users(self, round, num_users, return_idx=True):
    ...
    def evaluate(self, writer, glob_iter, save=True, selected=False):
        ...
        if save:
            writer.add_scalar('server_acc', glob_acc, glob_iter)
            writer.add_scalar('server_loss', glob_loss, glob_iter)
